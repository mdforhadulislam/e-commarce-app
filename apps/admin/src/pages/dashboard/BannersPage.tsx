...
export default function BannersPage() {
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      await axiosPrivate.post("/banners/bulk-delete", { ids: selectedBanners });
      toast({
        title: "Success",
            ...
            >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" {...field} disabled={formLoading} min={0} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Sale Text (Optional)</FormLabel>
                      <FormControl>
                        <Input {...field} placeholder="e.g. Summer Sale" disabled={formLoading} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="e.g. 50% OFF" disabled={formLoading} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
